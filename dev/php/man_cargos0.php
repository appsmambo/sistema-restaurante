        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="man_cargos1.php" class="btn btn-sm btn-info">Agregar Cargos</a></h3>
              <div class="box-tools">
...
<?php
	...
	$consulta = mysqli_query($con, "select id_cargo, nombre from man_cargos".$vlCad01." order by nombre");
...
?>
                <tr onClick="javascript:location.href='man_cargos1.php?id=<?php echo $row[id_cargo];?>';" style="cursor:pointer">
