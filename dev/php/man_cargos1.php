<?php
	...
	if($id > 0){
		...
		$consulta = mysqli_query($con, "select * from man_cargos where id_cargo='$id'");
...
<script language="javascript">
	function eliminar(a){
		location.href = "../sql/cargos_eliminar.php?id="+a;
	}
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="form1" name="form1" action="../sql/cargos_grabar.php" method="post">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-default" onClick="javascript:location.href='man_cargos0.php'">Cancelar</button>
