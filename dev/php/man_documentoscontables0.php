        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="man_documentoscontables1.php" class="btn btn-sm btn-info">Agregar Documento Contable</a></h3>
              <div class="box-tools">
...
<?php
	...
	$consulta = mysqli_query($con, "select id_docuconta, nombre from man_docuconta".$vlCad01." order by nombre");
...
?>
                <tr onClick="javascript:location.href='man_documentoscontables1.php?id=<?php echo $row[id_docuconta];?>';" style="cursor:pointer">
