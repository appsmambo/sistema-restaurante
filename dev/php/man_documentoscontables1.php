<?php
	...
	if($id > 0){
		...
		$consulta = mysqli_query($con, "select * from man_docuconta where id_docuconta='$id'");
		if(mysqli_num_rows($consulta) > 0){
			$row = mysqli_fetch_array($consulta);
			$id_cargo = $row[id_docuconta];
			$nombre   = $row[nombre];
		}
	}
?>
...
<script language="javascript">
	function eliminar(a){
		location.href = "../sql/documentoscontables_eliminar.php?id="+a;
	}
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="form1" name="form1" action="../sql/documentoscontables_grabar.php" method="post">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-default" onClick="javascript:location.href='man_documentoscontables0.php'">Cancelar</button>
