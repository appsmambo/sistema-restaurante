        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="man_empresas1.php" class="btn btn-sm btn-info">Agregar Empresas</a></h3>
              <div class="box-tools">
...
<?php
	$vlCad01 = "";
	if(!empty($txtBuscar)){
		$vlCad01 = " where ruc like '%$txtBuscar%' or nombre like '%$txtBuscar%' or direccion like '%$txtBuscar%' or distrito like '%$txtBuscar%' or telefono like '%$txtBuscar%'";
	}
	@mysqli_query($con, "SET NAMES 'utf8'");
	$consulta = mysqli_query($con, "select id_empresa, ruc, nombre, direccion, distrito, telefono from man_empresas".$vlCad01." order by nombre");
...
?>
                <tr onClick="javascript:location.href='man_empresas1.php?id=<?php echo $row[id_empresa];?>';" style="cursor:pointer">
