<?php
	...
	if($id > 0){
		...
		$consulta = mysqli_query($con, "select * from man_empresas where id_empresa='$id'");
...
<script language="javascript">
	function eliminar(a){
		location.href = "../sql/empresas_eliminar.php?id="+a;
	}

	function buscar_proveedores(a,b){
		$.ajax({
			url: "../sql/empresas_existe.php",
			type: "POST",
			data: "valor="+a+"&id="+b,
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="form1" name="form1" action="../sql/empresas_grabar.php" method="post">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-default" onClick="javascript:location.href='man_empresas0.php'">Cancelar</button>
