        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="man_mesas1.php" class="btn btn-sm btn-info">Agregar Mesa</a></h3>
              <div class="box-tools">
...
<?php
	$vlCad01 = "";
	if(!empty($txtBuscar)){
		$vlCad01 = " and id_mesa like '%$txtBuscar%'";
	}
	@mysqli_query($con, "SET NAMES 'utf8'");
	$consulta = mysqli_query($con, "select id, id_mesa as nombre from man_mesas where id_empresa='$vgCodEmp' and id_sucursal='$vgCodSuc'".$vlCad01." order by id_mesa");
...
?>
                <tr onClick="javascript:location.href='man_mesas1.php?id=<?php echo $row[id];?>';" style="cursor:pointer">
