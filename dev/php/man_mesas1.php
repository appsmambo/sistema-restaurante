<?php
	...
	if($id > 0){
		...
		$consulta = mysqli_query($con, "select * from man_mesas where id='$id'");
...
<script language="javascript">
	function eliminar(a){
		location.href = "../sql/mesas_eliminar.php?id="+a;
	}
	function buscar_mesas(b,c){
		$.ajax({
			url: "../sql/mesas_existe.php",
			type: "POST",
			data: "valor="+b+"&id="+c,
...
<body class="hold-transition skin-purple sidebar-collapse sidebar-mini" onLoad="javascript:document.form1.txtNombre.focus();">
<!-- Site wrapper -->
<div class="wrapper">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="form1" name="form1" action="../sql/mesas_grabar.php" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nombre (*)</label>
                  <input name="txtNombre" type="number" class="form-control" id="txtNombre" style="text-transform:uppercase" value="<?php echo $nombre;?>" maxlength="30" placeholder="" autocomplete="off" onBlur="buscar_mesas(document.getElementById('txtNombre').value,<?php echo $id;?>);" >
              ...
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-default" onClick="javascript:location.href='man_mesas0.php'">Cancelar</button>
