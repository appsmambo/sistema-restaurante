<?php
	...
	if($id > 0){
		...
		$consulta = mysqli_query($con, "select * from man_productos where id_producto='$id'");
...
<script language="javascript">
	function eliminar(a){
		location.href = "../sql/productos_eliminar.php?tipo=<?php echo $tipo;?>&nomtipo=<?php echo $nomtipo;?>&id="+a;
	}
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="form1" name="form1" action="../sql/productos_grabar.php" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nombre (*)</label>
                  <input name="txtNombre" type="text" class="form-control" id="txtNombre" style="text-transform:uppercase" value="<?php echo $nombre;?>" maxlength="70" placeholder="" autocomplete="off" >
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Precio (*)</label>
                  <input name="txtPrecio" type="number" step="0.01" class="form-control" id="txtPrecio" style="text-transform:uppercase; width:100px" value="<?php echo $precio;?>" maxlength="6" placeholder="" autocomplete="off" >
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-default" onClick="javascript:location.href='man_productos1.php?tipo=<?php echo $tipo;?>&nomtipo=<?php echo $nomtipo;?>'">Cancelar</button>
                ...
                <input name="nomtipo" type="hidden" id="nomtipo" value="<?php echo $nomtipo;?>">
              </div>
            </form>
          </div>
        </div>
...
<script>
	$(document).ready(function () {
		...
		$("#txtNombre").keyup(function(){
			...
			nombre2 = $("#txtPrecio").val();
			if(nombre1.length>=4 && nombre2.length>=2){
		...
		$("#txtPrecio").keyup(function(){
			nombre1 = $("#txtNombre").val();
			nombre2 = $("#txtPrecio").val();
			if(nombre1.length>=1 && nombre2.length>0){
				document.getElementById("btnGrabar").disabled = false;
			}else{
				document.getElementById("btnGrabar").disabled = true;
			}
