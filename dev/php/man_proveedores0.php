        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="man_proveedores1.php" class="btn btn-sm btn-info">Agregar Proveedor</a></h3>
              <div class="box-tools">
...
<?php
	$vlCad01 = "";
	if(!empty($txtBuscar)){
		$vlCad01 = " where ruc like '%$txtBuscar%' or razon_social like '%$txtBuscar%' or direccion like '%$txtBuscar%' or distrito like '%$txtBuscar%' or telefono like '%$txtBuscar%'";
	}
	@mysqli_query($con, "SET NAMES 'utf8'");
	$consulta = mysqli_query($con, "select id_proveedor, ruc, razon_social, direccion, distrito, telefono from man_proveedores".$vlCad01." order by razon_social");
...
?>
                <tr onClick="javascript:location.href='man_proveedores1.php?id=<?php echo $row[id_proveedor];?>';" style="cursor:pointer">
