        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="man_tipodocumentos1.php" class="btn btn-sm btn-info">Agregar Tipos de Documentos</a></h3>
              <div class="box-tools">
...
<?php
	...
	$consulta = mysqli_query($con, "select id_tipodocumento, nombre from man_tipodocumentos".$vlCad01." order by nombre");
...
?>
                <tr onClick="javascript:location.href='man_tipodocumentos1.php?id=<?php echo $row[id_tipodocumento];?>';" style="cursor:pointer">
