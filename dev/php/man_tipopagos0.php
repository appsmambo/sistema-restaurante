        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="man_tipopagos1.php" class="btn btn-sm btn-info">Agregar Tipos de Pagos</a></h3>
              <div class="box-tools">
...
<?php
	...
	$consulta = mysqli_query($con, "select id_tipopago, nombre from man_tipopagos".$vlCad01." order by nombre");
...
?>
                <tr onClick="javascript:location.href='man_tipopagos1.php?id=<?php echo $row[id_tipopago];?>';" style="cursor:pointer">
