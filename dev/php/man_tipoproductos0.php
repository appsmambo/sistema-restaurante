        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="man_tipoproductos1.php" class="btn btn-sm btn-info">Agregar Tipo de Productos</a></h3>
              <div class="box-tools">
...
<?php
	$vlCad01 = "";
	if(!empty($txtBuscar)){
		$vlCad01 = " where nombre like '%$txtBuscar%' or destino like '%$txtBuscar%'";
	}
	@mysqli_query($con, "SET NAMES 'utf8'");
	$consulta = mysqli_query($con, "select id_tipoproducto, nombre, destino from man_tipoproductos".$vlCad01." order by nombre");
...
?>
                <tr onClick="javascript:location.href='man_tipoproductos1.php?id=<?php echo $row[id_tipoproducto];?>';" style="cursor:pointer">
                  <td><?php echo $row[nombre];?></td>
                  <td><?php echo $vlDestino;?></td>
                  </tr>
<?php }?>
                </tbody>
              </table>
