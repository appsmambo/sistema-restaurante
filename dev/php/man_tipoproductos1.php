<?php
	...
	if($id > 0){
		...
		$consulta = mysqli_query($con, "select * from man_tipoproductos where id_tipoproducto='$id'");
...
<script language="javascript">
	function eliminar(a){
		location.href = "../sql/tipoproductos_eliminar.php?id="+a;
	}
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="form1" name="form1" action="../sql/tipoproductos_grabar.php" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>Destino</label>
                  <select class="form-control select2" id="cboDestino" name="cboDestino" style="width: 100%" >
                    <option value=""></option>
                    <option value="COCINA" <?php if($destino=="COCINA"){ echo "selected";}?>>COCINA</option>
                    <option value="BAR" <?php if($destino=="BAR"){ echo "selected";}?>>BAR</option>
                  </select>
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-default" onClick="javascript:location.href='man_tipoproductos0.php'">Cancelar</button>
...
<script>
	$(document).ready(function () {
		...
		$("#txtNombre").keyup(function(){
			...
			nombre2 = $("#cboDestino").val();
			if(nombre1.length>=4 && nombre2.length>=1){
