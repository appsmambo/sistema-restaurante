<?php
	...
	if($id > 0){
		...
		$consulta = mysqli_query($con, "select * from man_unidadmedida where id_umed='$id'");
...
<script language="javascript">
	function eliminar(a){
		location.href = "../sql/unidadmedida_eliminar.php?id="+a;
	}
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="form1" name="form1" action="../sql/unidadmedida_grabar.php" method="post">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-default" onClick="javascript:location.href='man_unidadmedida0.php'">Cancelar</button>
