...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Cocina</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12" style="cursor:pointer" onClick="javascript:alert('Hola');">
          <div class="info-box bg-aqua">
            <span class="info-box-icon"><i class="fa fa-file-text"></i></span>

            <div class="info-box-content">
              <span class="info-box-text">Mesa 01</span>
              <span class="info-box-number">S/ 180.50</span>

              <div class="progress">
                <div class="progress-bar" style="width: 100%"></div>
              </div>
                  <span class="progress-description">
                    Mozo: Diego Angeldones
                  </span>
            </div>
            <!-- /.info-box-content -->
          </div>
