        ...
        <div class="col-md-3">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-cutlery"></i>&nbsp Platos atendidos</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <div class="pull-right text-gray">
                ...
                <span class="time" title="Cocinero que despacho"><i class="fa fa-user"></i> <?php echo $row00["user_prepara"];?></span>&nbsp|&nbsp
                <span class="time" title="Hora de despacho"><i class="fa fa-clock-o"></i> <?php echo $row00["hora"];?></span>&nbsp|&nbsp
                <span class="time" title="Tiempo que tomo para preparar el plato"><i class="fa fa-hourglass-2 "></i> <?php echo $row00["demora"];?> min</span>
              </div>
              <hr>
              <?php }?>
