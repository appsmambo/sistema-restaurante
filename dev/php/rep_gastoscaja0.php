                    ...
                    <div class="box">
                        <div class="box-body" style="background-color: #222D32; color:#FFFFFF; height:53px;">
                            <div class="col-md-12" style="text-align:center">
                                <span id="lblTitulo" style="font-size:20px;">GASTOS DE CAJA</span>
                            </div>
                        ...
                        <div class="box-body">
                            <div class="col-md-2">
                                ...
                                <label class="control-label" for="inputSuccess">FECHA INICIO</label>
                                    <input type="date" class="form-control" id="txtFecIni" value="<?php echo $vlFecha_inicio;?>" autofocus>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group has-success">
                            ...
                            <div class="col-md-8">
                                <div class="form-group has-success">
                                    <br><button type="button" id="btnTipDoc" name="btnTipDoc" style="height:40px; width:150px; font-size:18px; background-color:#605CA8" class="btn btn-block btn-success pull-left" onClick="javascript:buscar();" style="height:60px"><i class="fa fa-refresh"></i>&nbsp&nbsp BUSCAR</button>
                                    <button type="button" id="btnNuevo" name="btnNuevo" style="height:40px; width:150px; font-size:18px; background-color:#605CA8" class="btn btn-block btn-info pull-right" onClick="javascript:nuevo();" style="height:60px"><i class="fa fa-money"></i>&nbsp&nbsp NUEVO</button>
                                </div>
                            </div>
...
<script>
    function buscar(){
        ...
        cargarMenu("#grid","rep_gastoscaja1.php?ini="+ini+"&fin="+fin);
    }
